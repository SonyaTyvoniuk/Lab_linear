...
Console.Write(" Введiть перше цiле число (День):");
...
Console.Write($"Чи можуть числа бути днем і мiсяцем?");
...
if (numbe2 >= 13)
{
    ...
    Console.WriteLine("Так, цi числа можуть бути днем i мiсяцем");
...
//3 завдання
Console.WriteLine($" Введiть цiле число x:");
int x =
...
{
    Console.WriteLine("Доба триває не бiльше ніж 24 годин)");
}
